...
Qualitative Analysis (NLP): Analyzes daily text logs to detect hidden stress and burnout.The goal is not just to predict failure, but to provide actionable counseling strategies based on the specific intersection of a student's performance and mental health.
